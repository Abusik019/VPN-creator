                        ...
                        <ul className={styles.premiumList}>
                            ...
                            <li>
                                ...
                                <h3>
                                    ...
                                    информируйте их о скидках, либо продавайте
                                    рекламу.
                                </h3>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <h3>
                                    Включите партнерку, чтобы пользователь
                                    в вашем боте получал 3 дня за приглашённого
                                    пользователя, а приглашённый получал 7 дней.
                                </h3>
                            </li>
                            <li>
                                <h2>Обязательная подписка</h2>
                                <h3>
                                    Поставь свой канал на обязательную подписку.
                                </h3>
                            </li>
                            <li>
